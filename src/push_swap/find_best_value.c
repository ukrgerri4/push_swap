...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/20 17:41:32 by ikryvenk          #+#    #+#             */
/*   Updated: 2017/03/20 17:42:26 by ikryvenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		try_rotate(t_dlist *l_start, t_dlist *l_a, t_dlist *l_b,
		t_info *info)
{
	int	i;
...
void		try_rev_rotate(t_dlist *l_start, t_dlist *l_a, t_dlist *l_b,
		t_info *info)
{
	int i;
