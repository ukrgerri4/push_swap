...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/20 17:50:52 by ikryvenk          #+#    #+#             */
/*   Updated: 2017/03/20 18:55:02 by ikryvenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			try_rotate(t_dlist *l_start, t_dlist *l_a,
		t_dlist *l_b, t_info *info);
void			try_rev_rotate(t_dlist *l_start, t_dlist *l_a,
		t_dlist *l_b, t_info *info);
